...
/// <summary>
/// Server-side Receipt Voucher (سند قبض) renderer — same Navy/Gold identity as the sales invoice
/// PDF, with a green accent on the amount box marking it as an inbound cash document.
/// </summary>
