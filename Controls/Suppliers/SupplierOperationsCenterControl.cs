...
public sealed class SupplierOperationsCenterControl : UserControl
{
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        using var perfScope = ScreenLoadProfiler.Begin("Suppliers.OperationsCenter");
        var result = await ScreenLoadProfiler.MeasureLoadAsync(perfScope, () => SupplierUiService.Instance.GetOperationsCenterAsync(_supplierId));
