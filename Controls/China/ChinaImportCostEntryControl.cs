...
{
    private readonly TextBox _invoiceUsd = ErpUiFactory.FormCostEntryAmountField("");
    private readonly TextBox _invoiceNote = ErpUiFactory.FormCostEntryNoteField();
    private readonly TextBox _weightKg = ErpUiFactory.FormCostEntryAmountField("");
    private readonly TextBox _shippingUsd = ErpUiFactory.FormCostEntryAmountField("");
    private readonly TextBox _shippingNote = ErpUiFactory.FormCostEntryNoteField();
    private readonly TextBox _insuranceUsd = ErpUiFactory.FormCostEntryAmountField("");
    private readonly TextBox _insuranceNote = ErpUiFactory.FormCostEntryNoteField();
    private readonly TextBox _customsClearanceUsd = ErpUiFactory.FormCostEntryAmountField("");
    private readonly TextBox _customsClearanceNote = ErpUiFactory.FormCostEntryNoteField();
    private readonly TextBox _other1Usd = ErpUiFactory.FormCostEntryAmountField("0");
    private readonly TextBox _other1Note = ErpUiFactory.FormCostEntryNoteField();
    private readonly TextBox _other2Usd = ErpUiFactory.FormCostEntryAmountField("0");
    private readonly TextBox _other2Note = ErpUiFactory.FormCostEntryNoteField();
    private readonly TextBox _other3Usd = ErpUiFactory.FormCostEntryAmountField("0");
    private readonly TextBox _other3Note = ErpUiFactory.FormCostEntryNoteField();
    private readonly TextBox _other4Usd = ErpUiFactory.FormCostEntryAmountField("0");
    private readonly TextBox _other4Note = ErpUiFactory.FormCostEntryNoteField();
