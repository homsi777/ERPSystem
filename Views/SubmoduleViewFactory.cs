...
namespace ERPSystem.Views
{
    public static class SubmoduleViewFactory
    {
        public static UserControl Create(AppModule module, string key) => (module, key) switch
        {
            ...
            (AppModule.Accounting, "OpeningBalances") => FinanceViews.Create(key),
            (AppModule.Accounting, "OpeningBalanceWorkspace") => FinanceViews.Create(key),
            (AppModule.Accounting, "OpeningBalanceDashboard") => FinanceViews.Create(key),
