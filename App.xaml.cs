...
public partial class App : System.Windows.Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        try
        {
            ...
            services.AddSingleton<IKartelaLabelRenderer, KartelaLabelRenderer>();
            services.AddSingleton<IKartelaLabelPrintService, KartelaLabelPrintService>();
            services.AddTransient<KartelaLabelDesignerViewModel>();
            services.AddTransient<KartelaLabelDesignerView>();
