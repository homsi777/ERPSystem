...
public static class ModuleReportRegistry
{
    public static IReadOnlyList<ModuleReportDef> Get(AppModule module) => module switch
    {
        ...
        [
            ...
            new("inv.length_analysis", "تحليل أطوال مادة", "تفصيل كل توب وطوله المتبقي حسب الصنف والمستودع", "\uE821", "تحليلي"),
        ...
        [
            ...
            new("sal.discounts", "تحليل الخصومات", "خصومات البيع حسب العميل والمنتج والسبب", "\uE945", "تحليلي"),
