...
namespace ERPSystem.Core.Customers
{
    ...
    public static class CustomerSampleData
    {
        ...
        private static readonly string[] ArabicNames = {
            ...
            "فهد سعد القحطاني", "شركة الرياض للأقمشة", "عبدالله محمد الزهراني",
            "مؤسسة الخليج للاستيراد", "سلمى إبراهيم الحربي", "شركة الفجر للتجارة",
            "خالد عمر الشهري", "مجموعة النخبة للنسيج", "يوسف علي المطيري",
            "مؤسسة الساهر للأقمشة", "نورة حمد العنزي", "مؤسسة الربيع للاستيراد",
            "عمر سعيد الغامدي", "شركة ذروة للتوزيع", "هند محمد القرني",
            "مجموعة الريادة للأقمشة", "أحمد علي الدوسري", "مؤسسة البناء للنسيج",
            "فاطمة سالم البلوي", "شركة نجد للاستيراد", "تركي عبدالرحمن العسيري",
